 ...
 *
 */
public class ExtraColorSensor implements I2cController.I2cPortReadyCallback, ColorSensor {
    public static volatile int ADDRESS_I2C = 0x38;
    ...
    public ExtraColorSensor(DeviceInterfaceModule deviceInterfaceModule, int physicalPort) {
        ...
        deviceInterfaceModule.enableI2cReadMode(physicalPort, I2cAddr.create7bit(ADDRESS_I2C), ADDRESS_COMMAND, BUFFER_LENGTH);
    ...
    public void setI2cAddress(I2cAddr newAddress) {
        setNewI2CAddress(newAddress.get7Bit());
    }

    @Override
    public I2cAddr getI2cAddress() {
        return I2cAddr.create7bit(ADDRESS_I2C);
    }
    ...
    public void portIsReady(int port) {
        ...
        if(this.f == SATTE.WRITE_DIRTY) {
            this.a.enableI2cWriteMode(this.h, I2cAddr.create7bit(ADDRESS_I2C), ADDRESS_COMMAND, BUFFER_LENGTH);
